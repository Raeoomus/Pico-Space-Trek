...
'TODO:Fix font height from 20 to 18
...
Sub Arriving
  ...
  SNA(U,V)=snaShip
'TODO: 641 GoSub 1390
  If W<1 Then ScanQuandrant:Return
  UpdateStartdate
  ScanQuandrant
End Sub
